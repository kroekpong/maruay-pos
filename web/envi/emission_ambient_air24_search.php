							...
							<div class="col-lg-6">
								<div class="form-group">
									...
									<div class="col-lg-6">
										 ...
										 <!-- costom monthrangepicker -->
										<!-- <div class="input-group">
										<div class="input-group-addon">
											<i class="fa fa-calendar"></i>
										</div>
										<input type="text" class="form-control pull-right mrp-container" id="monthrange" name="monthrange">
				...
				<div class="box box-solid">
					<div class="box-header with-border">
						...
						<div class="box-tools pull-right">
							<button type="button" class="btn btn-box-tool btn-success btn-table" data-toggle="modal" data-target="#myModal">
					...
					<div class="box-body">
						<div class="nav-tabs-custom">
							<ul class="nav nav-tabs" id="tab_tpac">
								...
								<li>
									<a href="#tab_1" data-toggle="tab">Methylene Chloride</a>
								</li>
							</ul>
