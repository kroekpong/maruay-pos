		 ...
		 <div class="box-header with-border">
          ...
          <div class="box-body">
		   ...
		   <form class="form-horizontal" id="myForm" commandname="sysParam" method="post"> 
	          ...
	          <div class="col-lg-6">
	          <div class="form-group">
                    <label for="paramStatus" class="col-lg-4 control-label">Schedule Status</label>
                    <div class="col-lg-6">
...
<!-- 		  <br> -->
		  <div class="box box-primary"   id="rs_table"> 
			 <div class="box-header with-border">
	              ...
	              <div class="box-tools pull-right">
	                 <button type="button" class="btn btn-box-tool btn-success btn-table"  onclick="doSendMail()"><i class="fa fa-check-square-o"></i> Approve
	                </button>
